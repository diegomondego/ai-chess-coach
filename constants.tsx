...
// Standard Chess Piece Configuration
// Uses the provided SVG paths.

const PieceSVG = ({ children }: { children?: React.ReactNode }) => (
  <svg viewBox="0 0 45 45" className="w-full h-full drop-shadow-sm filter">
    {children}
  </svg>
);

export const PIECES: Record<string, React.ReactNode> = {
  // White Pieces
  'wP': (
    <PieceSVG>
      <g style={{ opacity: 1, fill: '#ffffff', fillOpacity: 1, fillRule: 'nonzero', stroke: '#000000', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'miter', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1 }}>
  ...
  'bP': (
    <PieceSVG>
      <g style={{ opacity: 1, fill: '#000000', fillOpacity: 1, fillRule: 'nonzero', stroke: '#000000', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'miter', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1 }}>
        <path d="M 22,9 C 19.79,9 18,10.79 18,13 C 18,13.89 18.29,14.71 18.78,15.38 C 16.83,16.5 15.5,18.59 15.5,21 C 15.5,23.03 16.44,24.84 17.91,26.03 C 14.91,27.09 10.5,31.58 10.5,39.5 L 33.5,39.5 C 33.5,31.58 29.09,27.09 26.09,26.03 C 27.56,24.84 28.5,23.03 28.5,21 C 28.5,18.59 27.17,16.5 25.22,15.38 C 25.71,14.71 26,13.89 26,13 C 26,10.79 24.21,9 22,9 z " />
      </g>
    </PieceSVG>
  ),
...
export const BOARD_THEME = {
  ...
  highlight: 'bg-[#baca44]', 
  check: 'bg-red-500/50',
  lastMove: 'bg-[#f5f682]/50', 
  validMove: 'after:content-[""] after:absolute after:w-3 after:h-3 after:bg-[rgba(0,0,0,0.15)] after:rounded-full',
  validCapture: 'after:content-[""] after:absolute after:w-[calc(100%-8px)] after:h-[calc(100%-8px)] after:rounded-full after:border-[6px] after:border-[rgba(0,0,0,0.15)]'
};
...
export const BOT_PERSONAS: BotPersona[] = [
  {
    ...
    name: 'Martin',
    rating: 1100,
    description: 'Casual player. Makes occasional blunders but knows the basics.',
    style: 'Play casually. Make simple developing moves. occasionally (20% of the time) overlook a tactic or leave a piece hanging.',
    avatarColor: '#8ca2ad',
    visualDescription: 'A cartoon style portrait of a confused man with brown hair scratching his head.',
    avatarImage: '/martin.png'
  },
  {
    id: 'bot_aria',
    name: 'Aria',
    rating: 1300,
    description: 'Intermediate. Good openings, solid mid-game.',
    style: 'Play solid opening principles. Avoid obvious blunders. Look for simple tactics.',
    avatarColor: '#6e96bb',
    visualDescription: 'A portrait of a focused young woman reading a book.',
    avatarImage: '/aria.png'
  },
  {
    id: 'bot_bob',
    name: 'Bob',
    rating: 1500,
    description: 'Club Player. Tactical and aggressive.',
    style: 'Play aggressively. Look for attacking combinations. Rarely makes unforced errors.',
    avatarColor: '#c4a450',
    visualDescription: 'A portrait of a cool guy in a varsity jacket with fire.',
    avatarImage: '/bob.png'
  },
  {
    id: 'bot_elena',
    name: 'Elena',
    rating: 1700,
    description: 'Strong Club. Positional and patient.',
    style: 'Play positionally. Improve piece activity slowly. Squeeze the opponent. Very low error rate.',
    avatarColor: '#d67575',
    visualDescription: 'A gentle portrait of an elderly woman holding tea.',
    avatarImage: '/elena.png'
  },
  {
    id: 'bot_sven',
    name: 'Sven',
    rating: 1900,
    description: 'Expert. Very precise calculation.',
    style: 'Play like an expert. Calculate lines deeply. Punish any small mistake instantly.',
    avatarColor: '#6f528a',
    visualDescription: 'A high-tech portrait of a man analyzing with a holographic interface.',
    avatarImage: '/sven.png'
  },
  {
    id: 'bot_antonio',
    name: 'Antonio',
    rating: 2100,
    description: 'Master. Tricky and resourceful.',
    style: 'Play like a Candidate Master. Use advanced theory. Set traps. Play consistently strong moves.',
    avatarColor: '#a83232',
    visualDescription: 'A classy portrait of a distinguished older gentleman.',
    avatarImage: '/antonio.png'
  }
];